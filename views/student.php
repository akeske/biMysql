...
<td>
	<form method="post" action="index_stu.php" name="insertStudentForm" class="pure-form">
		...
		<legend>Insert new student</legend>
			<input id="name" size="15" class="login_input" type="text" placeholder="Student name" pattern="[a-zA-Z0-9]{2,64}" autocomplete="off" name="name" required maxlength="12"/>
			<input id="address" size="15" class="login_input" type="text" name="address" required autocomplete="off" placeholder="Address" required maxlength="30"/>
